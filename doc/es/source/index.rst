...
+ Desarrollo
  ...
  + **Redistribución (RD)**: Crear paquetes, redistribuirlos, compilarlos para varios sistemas, portarlos a varios entornos, uso correcto de sistemas de control de versiones, etc.
